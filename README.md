...
**Hello Rails** is simple rails and react app to generate random message
...
```
git clone https://github.com/byiringiroscar/greeting-rails-with-react
...
Feel free to check the [issues page](https://github.com/byiringiroscar/greeting-rails-with-react/issues/new).
